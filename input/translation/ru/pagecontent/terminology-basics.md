...
**Найти все версии конкретной CodeSystem:**
```
...
1. **Разработка**: Используйте последнюю версию, чтобы оставаться актуальными
2. **Тестирование**: Тестируйте с несколькими версиями, если вы их поддерживаете
3. **Продакшн**: Привязывайтесь к конкретным версиям для согласованности
4. **Документация**: Документируйте, какие версии поддерживает ваше приложение
5. **Миграция**: Тщательно планируйте обновления версий, тщательно тестируйте
...
**Пример: Транслировать узбекский код профессии в SNOMED**
...
**Упражнение 11: Реализовать привязку версий**

Задача: Модифицировать реализацию Упражнения 10, чтобы:
- Привязаться к конкретной версии ValueSet
- Проверить, доступна ли новая версия
- Предоставить путь миграции при обновлении версий

Вопросы для изучения:
- Как обнаруживать изменения версий?
- Как тестировать против нескольких версий?
- Что происходит с данными, закодированными старыми версиями?

**Упражнение 12: Обрабатывать ошибки gracefully**

Задача: Реализовать всеобъемлющую обработку ошибок для всех операций терминологии:

1. Попробовать расширить несуществующий ValueSet
2. Попробовать валидировать код с неправильной системой
3. Попробовать искать несуществующий код
4. Попробовать расширить с неверной версией

Вопросы для изучения:
- Какие коды ошибок возвращаются?
- Как можно предоставить понятные пользователю сообщения об ошибках?
- Как логировать ошибки для отладки?
